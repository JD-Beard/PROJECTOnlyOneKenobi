...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'webGL export.data';
    var REMOTE_PACKAGE_BASE = 'webGL export.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 26224193;
      var PACKAGE_UUID = 'c7ec1dfa-44c7-4f92-b5bc-b249a7b15a68';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 23427129, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(23427129, 23427598, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(23427598, 23431624, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(23431624, 25321596, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(25321596, 26196568, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(26196568, 26224193, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_webGL export.data');

    };
    Module['addRunDependency']('datafile_webGL export.data');
